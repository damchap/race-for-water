...
const DateContainer = ({ partiDuCorp }: DateContainerProps) => {
    return (
        <>
        {partiDuCorp && (
        <div className="idden  md:flex  w-80 p-5 flex-col items-center gap-2 rounded-2xl border-[1.4px] border-white/40 bg-[rgba(128,128,128,0.30)] bg-blend-luminosity backdrop-blur-[50px]">
